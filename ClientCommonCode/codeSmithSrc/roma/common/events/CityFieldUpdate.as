...
package roma.common.events
{
	...
	public class CityFieldUpdate extends BaseResponse
	{
		public function CityFieldUpdate(type:String, data:Object,bubbles:Boolean=false, cancelable:Boolean=false)
		{
			super(type, bubbles, cancelable);
			this.setResponseData(data);
				if (data.bean!=null) {
					this.bean = new WildBean(data.bean);
				}
				if (data.cityId!=null) {
		...
		public var bean:WildBean;
		public var cityId:int;
		public var updateType:int;

		public function copyToBe(target:CityFieldUpdate):void {
			if (bean!=null) {
		...
		public override function toBeString(pre:String=""):String {
			var str:String = "---- CityFieldUpdate ----\n"  + this.toBeErrorString();
			if (bean!=null) {
