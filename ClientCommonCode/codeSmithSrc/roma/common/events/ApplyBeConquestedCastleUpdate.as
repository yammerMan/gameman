...
package roma.common.events
{
	...
	public class ApplyBeConquestedCastleUpdate extends BaseResponse
	{
		public function ApplyBeConquestedCastleUpdate(type:String, data:Object,bubbles:Boolean=false, cancelable:Boolean=false)
		{
		...
		public function copyToBe(target:ApplyBeConquestedCastleUpdate):void {
		...
		public override function toBeString(pre:String=""):String {
			var str:String = "---- ApplyBeConquestedCastleUpdate ----\n"  + this.toBeErrorString();
