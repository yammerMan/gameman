...
package roma.common.controller.rank
{
	...
	public class RankPlayerDataResponse extends BaseResponse
	{
		public function RankPlayerDataResponse(type:String, data:Object,bubbles:Boolean=false, cancelable:Boolean=false)
		{
			...
			this.setResponseData(data);
				...
				if (data.beans) {
					for (n=0; n<data.beans.length; n++) {
						var _beans:PlayerInfoDataBean = new PlayerInfoDataBean(data.beans[n]);
		...
		public function getBeans(index:int):PlayerInfoDataBean {
			var res:PlayerInfoDataBean = PlayerInfoDataBean(this.beansArray[index]);
			return res; 
		}
		public function setBeans(bean:PlayerInfoDataBean, index:int):void {
			this.beansArray[index] = bean;
		}

		public function copyToBe(target:RankPlayerDataResponse):void {
		...
		public override function toBeString(pre:String=""):String {
			var str:String = "---- RankPlayerDataResponse ----\n"  + this.toBeErrorString();
