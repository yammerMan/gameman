...
package roma.common.events
{
	...
	public class BuildingUpdate extends BaseResponse
	{
		public function BuildingUpdate(type:String, data:Object,bubbles:Boolean=false, cancelable:Boolean=false)
		{
			super(type, bubbles, cancelable);
			this.setResponseData(data);
				if (data.bean!=null) {
					this.bean = new ArchitectureBean(data.bean);
				}
				if (data.cityId!=null) {
		...
		public var bean:ArchitectureBean;
		public var cityId:int;
		public var updateType:int;

		public function copyToBe(target:BuildingUpdate):void {
			if (bean!=null) {
