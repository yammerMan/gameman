...
package roma.common.events
{
	...
	public class WorkerTrainningUpdate extends BaseResponse
	{
		public function WorkerTrainningUpdate(type:String, data:Object,bubbles:Boolean=false, cancelable:Boolean=false)
		{
			super(type, bubbles, cancelable);
			this.setResponseData(data);
				if (data.bean!=null) {
					this.bean = new WorkerTrainningBean(data.bean);
				}
				if (data.cityId!=null) {
		...
		public var bean:WorkerTrainningBean;
		public var cityId:int;
		public var updateType:int;

		public function copyToBe(target:WorkerTrainningUpdate):void {
			if (bean!=null) {
		...
		public override function toBeString(pre:String=""):String {
			var str:String = "---- WorkerTrainningUpdate ----\n"  + this.toBeErrorString();
			if (bean!=null) {
