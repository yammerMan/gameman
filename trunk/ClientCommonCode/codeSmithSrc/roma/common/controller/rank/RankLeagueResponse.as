...
package roma.common.controller.rank
{
	...
	public class RankLeagueResponse extends BaseResponse
	{
		public function RankLeagueResponse(type:String, data:Object,bubbles:Boolean=false, cancelable:Boolean=false)
		{
			...
			this.setResponseData(data);
				...
				if (data.beans) {
					for (n=0; n<data.beans.length; n++) {
						var _beans:RankLeagueBean = new RankLeagueBean(data.beans[n]);
		...
		public function getBeans(index:int):RankLeagueBean {
			var res:RankLeagueBean = RankLeagueBean(this.beansArray[index]);
			return res; 
		}
		public function setBeans(bean:RankLeagueBean, index:int):void {
			this.beansArray[index] = bean;
		}

		public function copyToBe(target:RankLeagueResponse):void {
		...
		public override function toBeString(pre:String=""):String {
			var str:String = "---- RankLeagueResponse ----\n"  + this.toBeErrorString();
