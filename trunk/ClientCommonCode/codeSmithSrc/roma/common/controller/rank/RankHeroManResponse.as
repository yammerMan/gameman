...
package roma.common.controller.rank
{
	...
	public class RankHeroManResponse extends BaseResponse
	{
		public function RankHeroManResponse(type:String, data:Object,bubbles:Boolean=false, cancelable:Boolean=false)
		{
			...
			this.setResponseData(data);
				...
				if (data.beans) {
					for (n=0; n<data.beans.length; n++) {
						var _beans:RankHeroManBean = new RankHeroManBean(data.beans[n]);
		...
		public function getBeans(index:int):RankHeroManBean {
			var res:RankHeroManBean = RankHeroManBean(this.beansArray[index]);
			return res; 
		}
		public function setBeans(bean:RankHeroManBean, index:int):void {
			this.beansArray[index] = bean;
		}

		public function copyToBe(target:RankHeroManResponse):void {
		...
		public override function toBeString(pre:String=""):String {
			var str:String = "---- RankHeroManResponse ----\n"  + this.toBeErrorString();
