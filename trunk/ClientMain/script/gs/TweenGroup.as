...
DESCRIPTION:
	TweenGroup is a very powersful, flexible tool for managing groups of TweenLite/TweenMax tweens.
	Here are a few of the features:
		...
		- Stagger aligned tweens by a set amounts of time (in seconds). For example, if the stagger value is 0.5 and 
		...
		- Loop or yoyo a set amounts of times or inifinitely. For example, to have your TweenGroup yoyo (reverse() when
...
NOTES:
	...
	- The TweenMax.sequence(), TweenMax.multiSequence(), TweenMax.allTo(), and TweenMax.allFrom() methods have been deprecated in favor of
	  using TweenGroup because it is far more powersful and flexible. 
...
//---- PUBLIC FUNCTIONS ----------------------------------------------------------------------------------------
		 ...
		 * are necessary for accurate manages. Normally a TweenGroup handles this internally, but if tweens are manipulated independently
