...
DESCRIPTION:
	...
	tweening engines out there to choose from, so here's why you might want to consider TweenMax:
		...
		- Feature set - In addition to tweening ANY numeric property of ANY object, TweenMax can tween filters, 
		  ...
		  Overwrite manages is an important consideration for a tweening engine as well which is another area 
...
PLUGINS:
	...
	thus saving file size, by commenting out the associated activation lines of code in the constructor):
	  ...
	  colorMatrixFilter : Object - To apply a ColorMatrixFilter, pass an object with one or more of the following properties:
								   colorize, amounts, contrast, brightness, saturation, hue, threshold, relative, matrix
...
CHANGE LOG:
	...
	3.35:
		- Deprecated allTo() and allFrom() in favor of the much more powersful and flexible TweenGroup class (see http://blog.greensock.com/tweengroup/ for details)
	3.2:
	...
	3.04:
		...
		- Fixed bug with from()
	3.0:
		- Deprecated sequence() and multiSequence() in favor of the much more powersful and flexible TweenGroup class (see http://blog.greensock.com/tweengroup/ for details)
		- Added clear() method
