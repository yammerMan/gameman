...
package roma.logic.object.building.impl
{
	...
	import animation.aniSet.building.StableAniSet;
	...
	public class Stable extends BaseBuilding
	{
		public function Stable(bean:ArchitectureBean)
		{
			super(bean);
		}
		...
		override protected function getNormalAniPLayer():IAniPlayer {
			return new StableAniSet();			
		}

		public function getStableAccPer():Number{
		...
		public function getTroopAry():ArrayCollection{
			return new ArrayCollection([TroopForConstants.T_SCOUT,TroopForConstants.T_CAVALRY]);		
		}
