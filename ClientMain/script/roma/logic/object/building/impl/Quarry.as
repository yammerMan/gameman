package roma.logic.object.building.impl
{
	...
	{
		public function Quarry(bean:ArchitectureBean)
		{
			super(bean);
		}
		...
		override protected function getNormalAniPLayer():IAniPlayer {
			return new AniPlayer(AnimationManager.buildings.quarryNormal);			
		}

		override protected function initAni():void {
			this.normalAniPlayer = new AniPlayer(AnimationManager.buildings.quarryNormal);
			this.addConstructingAni(AnimationManager.buildings.workingPeople1 , 10 , 40);
			this.addConstructingAni(AnimationManager.buildings.workingPeople , 80 , 40);
			
			this.levelBgPlayer.sceneX=35;
			this.levelBgPlayer.sceneY=12;
...
//				}
//				if(rule.buff1!=0){
//					return Lang.msg("building.quarry.funcSpecial",rule.buildingLevel,BuildingHelper.instance.getName(this.typeId), rule.buff1);
//				}
//			} 
//			return "";
//		}
