...
USAGE:
	...
	to keep in mind:
		...
		- The changeFactor setter will be updated on every frame during the course of the tween with a multiplier
		  that describes the amounts of change based on how far along the tween is and the ease applied. It will be 
...
package gs.plugins {
	...
	public class TweenPlugin {
		 ...
		 *  
		 * @param $changeFactor Multiplier describing the amounts of change that should be applied. It will be zero at the beginning of the tween and 1 at the end, but inbetween it could be any value based on the ease applied (for example, an Elastic tween would cause the value to shoot past 1 and back again before the end of the tween) 
		 */
		...
		/**
		 * In most cases, your custom updating code should go here. The changeFactor value describes the amounts 
		 ...
		 * 
		 * @param $n Multiplier describing the amounts of change that should be applied. It will be zero at the beginning of the tween and 1 at the end, but inbetween it could be any value based on the ease applied (for example, an Elastic tween would cause the value to shoot past 1 and back again before the end of the tween) 
		 */
