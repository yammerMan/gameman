package skins
{
	...
	public class DayTimeSkin extends MyRectangularBorder
	{
		public function DayTimeSkin() 
		{
			super();
		}
        ...
        override protected function updateDisplayList(w:Number, h:Number):void {
            ...
            tile1.copyPixels(tile,new Rectangle(0, 0,background.width, background.height/2),new Point(0,0));  
