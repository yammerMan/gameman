package skins
{
	...
	public class ChatBGSkin extends RecBorder
	{
		public function ChatBGSkin() 
		{
			super();
		}
		[Embed("assets/images/EmbedImages/chat/chatBG.png")]
		private var imgCls:Class;//设置之后不接收css定义的背景设置
		
	    private var bit:Graphics = graphics;
		private var tile:BitmapData;//背景图
		private var topV:int=20;
		private var bottomV:int=40;
...
//			  var tile8:BitmapData = new BitmapData(rightV,bottomV);
			  ...
			  bit.clear();
                ...
                bit.drawRect(leftV, topV-1, w-leftV-rightV, h-topV-bottomV+2);
